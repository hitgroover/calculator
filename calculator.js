...
const getValueAsStr = () => {
    ...
    return currentValueStr.replace(/\s/g, "");
};
...
const getResultOfOperationAsStr = () => {
    ...
    if (operatorInMemory === 'multiplication') {
        newValueNum = valueNumInMemory * currentValueNum;
    } 
    
    if (operatorInMemory === 'division') {
        newValueNum = valueNumInMemory / currentValueNum;
    };
...
// add event listeners fo functions
...
for (let i = 0; i < numberElArray.length; i++){
    numberElArray[i].addEventListener('click', () => {
